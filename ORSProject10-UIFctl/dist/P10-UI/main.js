...
/* harmony import */ var _emp_emp_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./emp/emp.component */ "./src/app/emp/emp.component.ts");
/* harmony import */ var _emp_emplist_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./emp/emplist.component */ "./src/app/emp/emplist.component.ts");
...
var routes = [
    ...
    { path: 'changepassword',
        ...
        path: 'emp',
        component: _emp_emp_component__WEBPACK_IMPORTED_MODULE_34__["EmpComponent"]
    }, {
        path: 'emplist',
        component: _emp_emplist_component__WEBPACK_IMPORTED_MODULE_35__["EmpListComponent"]
    }, {
        path: 'emp/:id',
        component: _emp_emp_component__WEBPACK_IMPORTED_MODULE_34__["EmpComponent"]
    }
...
/* harmony import */ var _emp_emp_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./emp/emp.component */ "./src/app/emp/emp.component.ts");
/* harmony import */ var _emp_emplist_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./emp/emplist.component */ "./src/app/emp/emplist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _emp_emp_component__WEBPACK_IMPORTED_MODULE_46__["EmpComponent"],
                _emp_emplist_component__WEBPACK_IMPORTED_MODULE_47__["EmpListComponent"],
            ],
            imports: [
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2VtcC9lbXAuY29tcG9uZW50LmNzcyJ9 */"
...
var EmpComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](EmpComponent, _super);
    function EmpComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.EMP, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.selected = null;
        return _this;
    }
    EmpComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
    ...
    EmpComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    EmpComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-emp',
            template: __webpack_require__(/*! ./emp.component.html */ "./src/app/emp/emp.component.html"),
...
/***/ "./src/app/emp/emplist.component.css":
/*!*******************************************!*\
  !*** ./src/app/emp/emplist.component.css ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2VtcC9lbXBsaXN0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/emp/emplist.component.html":
/*!********************************************!*\
  !*** ./src/app/emp/emplist.component.html ***!
  \********************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\n<div class=\"content-wrapper\" style=\"padding-top: 3%; padding-bottom: 15%; \nbackground: url(assets/files/96013.jpg) no-repeat center center;\nbackground-attachment: fixed;\nbackground-size: cover;width:auto;\n  height: 90vh;\">\n  <div class=\"container-fluid\">\n\n    <div class=\"panel panel-primary\">\n      <div class=\"panel-heading\" style=\"height: 70px;\">\n\n        <div class=\"text-center\">\n          <h2 class=\"text-primary font-weight-bold\">{{'Employe List' | translate }}</h2>\n\n        </div>\n      </div>\n\n      <div class=\"row p-1\">\n        <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.firstName\"\n            placeholder=\"{{'Search firstName' | translate }}\">\n        </div>\n        <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.department\"\n            placeholder=\"{{'Search department' | translate }}\">\n        </div>\n\n        <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.email\"\n            placeholder=\"{{'Search Email' | translate }}\">\n        </div>\n        <!-- <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.phoneNo\"\n            placeholder=\"{{'Search Mobile Number' | translate }}\">\n        </div> -->\n        <div class=\"col-sm-1\">\n          <button (click)=\"submit()\" class=\"btn btn-primary\">\n            {{'Search' | translate }}</button>\n        </div>\n\n\n\n        <div class=\"col-lg-2\">\n          <button (click)=\"forward('/emp')\" type=\"button\" class=\"btn btn-success\">{{'Add Employe' | translate }}\n          </button>\n        </div>\n\n\n        <div class=\"col-sm-1\">\n          <button (click)=\"deleteMany()\" class=\"btn btn-danger\">\n            {{'Delete'| translate}}</button>\n        </div>\n      </div>\n\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{form.message}}\n      </div>\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{form.message}}\n      </div>\n      <div class=\"p-1\">\n        <div class=\"table-responsive\">\n          <table class=\"table table-bordered table-striped table-hover\">\n            <thead class=\"thead-light text-uppercase\">\n              <tr align=\"center\">\n                <th><input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\" value=\"h1\"\n                    (change)=\"checkUncheckAll($event)\" /></th>\n                <th>{{'S.No' | translate }}</th>\n                <th>{{'First Name' | translate }}</th>\n                <th>{{'Last Name' | translate }}</th>\n                <th>{{'Email' | translate }}</th>\n                <th>{{'Department' | translate }}</th>\n                <th>{{'Address' | translate }}</th>\n                <th>{{'Edit' | translate}}</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\n                <td> <input type=\"checkbox\" #checkboxes (change)=\"checklistUpdate()\" name=\"list_name\" id=\"{{m.id}}\" value=\"{{isMasterSel}}\" /> </td>\n                <td> <h5 style=\"color: yellow;\">{{(form.pageNo*5)+i+ 1}} </h5></td>\n                <td> <h5 style=\"color: yellow;\">{{ m.firstName }} </h5></td>\n                <td> <h5 style=\"color: yellow;\">{{ m.lastName }} </h5></td>\n                <td> <h5 style=\"color: yellow;\">{{ m.email }} </h5></td>\n                <td><h5 style=\"color: yellow;\">{{m.department}}</h5></td>\n                <td><h5 style=\"color: yellow;\">{{m.address}}</h5></td>\n                <td>\n                  <a (click)=\"forward( '/emp/' +  m.id)\" style=\"cursor: pointer;\">\n                    <i class=\"fa fa-edit text-info\"></i>\n                  </a>\n                  <!-- /\n                  <a (click)=\"delete(m.id)\" style=\"cursor: pointer;\">\n                    <i class=\"fa fa-trash text-danger\"></i>\n                  </a> -->\n                </td>\n              </tr>\n            </tbody>\n          </table>\n          <table style=\"width: 100%;\">\n              <tr> <td style=\"width: 50%;\"><button (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">{{'Previous' |\n                    translate }} </button>\n                </td>  \n                <td *ngIf=\"form.list.length!=0\" style=\"width: 50%;\"></td>\n                <td *ngIf=\"form.list.length==0\" style=\"width: 50%;\"><a class=\"btn btn-warning mr-1\" [routerLink]=\"['/emplist']\" (click)=\"exit()\">{{'Back' | translate}}</a></td>\n                <td>\n                  <button (click)=\"next()\" [disabled]=\"nextList==0\" type=\"button\" class=\"btn btn-info\">{{'Next' | translate }} </button>\n                 </td>\n                </tr>\n              </table>\n          \n        </div>\n      </div>\n\n    </div>\n  </div>\n</div>\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/emp/emplist.component.ts":
/*!******************************************!*\
  !*** ./src/app/emp/emplist.component.ts ***!
  \******************************************/
...
var EmpListComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](EmpListComponent, _super);
    function EmpListComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.EMP, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    ...
    EmpListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./emplist.component.html */ "./src/app/emp/emplist.component.html"),
            styles: [__webpack_require__(/*! ./emplist.component.css */ "./src/app/emp/emplist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
    ], EmpListComponent);
...
module.exports = "<footer class=\"text-center \"\n style=\" background: #c471f5;\n  \n /* Chrome 10-25, Safari 5.1-6 */\n background: -webkit-linear-gradient(to right, rgba(196,113,245,0.95), rgba(250,113,205,0.95));\n\n /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\n background: linear-gradient(to right, rgba(196,113,245,0.95), rgba(250,113,205,0.95))\">\n  <!-- Copyright -->\n  <div class=\"text-center pt-2 pb-2 text-light\" >\n    &copy; {{'COPYRIGHT' | translate}}\n    <a class=\"text-light\" href=\"\">{{'NCS PVT. LTD' | translate}}</a>\n  </div>\n  <!-- Copyright -->\n</footer>"
...
var SignUpComponent = /** @class */ (function () {
    ...
    SignUpComponent.prototype.limitInput = function (event, maxLength) {
    ...
    SignUpComponent.prototype.limitInputw = function (event, maxLength) {
        var target = event.target;
        var value = target.value;
        if (value.length >= maxLength) {
            event.preventDefault();
...
var UserComponent = /** @class */ (function (_super) {
    ...
    UserComponent.prototype.onSubmitProfile = function (fileToUpload, userform) {
        ...
        formData.append('file', fileToUpload);
        console.log(this.form.data.id + 'this id number ======');
        return this.httpClient.post("http://localhost:8084/Auth/profilePic/" + this.form.data.id, formData);
    };
...
module.exports = __webpack_require__(/*! F:\Project10RahulFrontCtl\proect10_FrontCtl-main\ORSProject10-UIFctl\src\main.ts */"./src/main.ts");
